      ...
      if (e.keyword === "table") {
        ...
        e.create_definitions.forEach((d) => {
          ...
          if (d.resource === "column") {
            ...
            // Postgres array columns: the parser exposes the `ARRAY` keyword
            // form (e.g. `TEXT ARRAY`) as d.definition.array. Our exporter emits
            ...
            // Identity columns (`GENERATED BY DEFAULT AS IDENTITY`) are how our
            // exporter renders an incrementing field for Postgres; the parser
            // surfaces them as d.generated_by_default, not d.auto_increment.
