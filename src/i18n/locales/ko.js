...
const ko = {
  translation: {
    ...
    merging_column_w_inherited_definition:
      "상속된 정의가 있는 '{{tableName}}' 테이블의 '{{fieldName}}' 컬럼이 병합됩니다",
    no_saved_diagrams: "저장된 다이어그램이 없습니다",
    open_recent: "최근 항목 열기",
    saved_as_copy: "복사본으로 저장했습니다. 열기:",
    toolbar: "도구 모음",
    snap_to_grid: "그리드에 맞추기",
    show_datatype: "데이터 유형 표시",
    nullable: "NULL 허용",
    add: "추가",
    add_comment: "주석 추가",
    composite_key: "복합 키",
    composite_key_hint: "복합 키를 구성할 필드를 선택하세요",
    ...
    show_relationship_labels: "관계 라벨 표시",
    docs: "문서",
    ...
    restore_warning: "다른 버전을 불러오면 현재 변경 사항을 덮어씁니다.",
    return_to_current: "현재 다이어그램으로 돌아가기",
    ...
    migration_not_supported_generic:
      "일반 다이어그램은 마이그레이션을 지원하지 않습니다.",
    no_migration_needed: "필요한 마이그레이션이 없습니다",
    scripts: "스크립트",
    json_diff: "JSON 비교",
    download: "다운로드",
    insert_sql: "SQL 입력",
    ...
    custom_types_description:
      "기본으로 지원하지 않는 데이터 유형을 정의합니다. 생성하거나 컬럼을 편집할 때 사용할 수 있습니다.",
    type_data_corrupted: "설정된 유형 데이터가 손상되었습니다.",
    no_custom_types: "설정된 사용자 정의 유형이 없습니다",
    close: "닫기",
    add_custom_type: "사용자 정의 유형 추가",
    type_name_required: "유형 이름을 입력해야 합니다",
    database: "데이터베이스",
    saved: "저장됨",
    structure: "구조",
    code: "코드",
    ...
    primary_key: "기본 키",
    foreign_key: "외래 키",
    collaboration_connected: "연결됨",
    collaboration_connecting: "연결 중",
    collaboration_disconnected: "연결 끊김",
    ...
    diagrams: "다이어그램",
    templates: "템플릿",
    no_diagrams_match: "필터 조건에 맞는 다이어그램이 없습니다.",
    failed_to_load_diagrams: "다이어그램을 불러오지 못했습니다",
  },
};
