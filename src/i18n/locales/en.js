...
const en = {
  translation: {
    ...
    kind_fk: "Foreign key",
    kind_subtype: "Subtype (specialisation)",
    specialisation: "Specialisation",
    specialisation_group: "Group",
    disjoint: "Disjoint",
    overlapping: "Overlapping",
    total: "Total",
    partial: "Partial",
    discriminator: "Discriminator",
    no_discriminator: "None",
    participation: "Participation",
    mandatory: "Mandatory",
    optional: "Optional",
    participation_default: "Default",
    child_participation_hint:
      "Derived from NOT NULL on the foreign-key field; edit the field to change it.",
    sibling_sync_hint: "Applied to all links in this group: {{names}}",
    read_only: "Read only",
    continue: "Continue",
